-- Vibe-Code v2 Initial Schema
-- This file is applied to both SQLite and PostgreSQL
...
CREATE INDEX IF NOT EXISTS idx_autopilots_workspace_id ON autopilots(workspace_id);
CREATE INDEX IF NOT EXISTS idx_autopilots_skill_id ON autopilots(skill_id);
